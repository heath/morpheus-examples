...
$(importGQLDocumentWithNamespace "src/Sophisticated/shared.gql")


$(importGQLDocumentWithNamespace "src/Sophisticated/api.gql")
...
getDBUser _ = do
  ...
  pure $ Right User
    ...
    , userEntity  =
      pure
        [ MyUnionAddress Address { addressCity        = pure "city"
                                 , addressStreet      = pure "street"
